<div class="sidebar_right">
    <?php $activar_ads = get_option('activar-anuncio-300-250');
    if ($activar_ads == "true") { # activacion de anucios?>
        <div class="ads-300">
            <?php $ads = get_option('anuncio-300-250');
    ...
    <div class="links">
        <h3><?php if ($tex = get_option('text-46')) {
                echo $tex;
            } else {
                _e('More Series', 'mundothemes');
            } ?></h3>
        <?php //relacionados(); ?>
                ...
                while ($episode_query->have_posts()) : $episode_query->the_post();
                    ...
                    <li>
                        <a href="<?php the_permalink() ?>" rel="bookmark"
                           title="Free anime & cartoon link to <?php the_title_attribute(); ?>">
                            <?php the_title(); ?></a>
                    </li>
