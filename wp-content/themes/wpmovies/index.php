...
include_once 'sidebar_left.php'; ?>
    <div class="items">
        <div id="directorio">
            ...
            <div class="random">
                <?php
                include("includes/funciones/popular.php");
//                $estrenos = get_option('activar-estrenos');
//                if ($estrenos == "true") {
...
//                } ?>
            ...
            <span class="titulo_2" style="margin-bottom: 15px"><?php
                if ($tex = get_option('text-55')) {
                    ...
                    _e('Latest Episodes', 'mundothemes');
                } ?></span>
            </div>
            <div id="box_movies">
                <?php wp_reset_query(); ?>
                    ...
                    while (have_posts()):
                        ...
                        if (has_post_thumbnail()) {
                            ...
                            if (!empty($img)) {
                                ...
                                $img = get_post_custom_values("cover_url");
                                $imgsrc = $img[0];
                            }
                        ...
                        <div class="movie">
                            <div class="imagen">
                                ...
                                if ($values = get_post_custom_values("imdbRating")) { ?>
                                    <div class="imdb"><span class="icon-grade"></span> <?php
                            ...
                            <?php
                            if ($mostrar = $terms = strip_tags($terms = get_the_term_list($post->ID, '' . $year_estreno . ''))) { ?>
                                <span class="year"><?php
            ...
            <div id="paginador">
                <div class="pages_respo">
                    <div class="anterior"><?php
                        previous_posts_link('<span class="icon-caret-left"></span> Prev '); ?></div>
                    <div class="siguiente"><?php
                        next_posts_link('Next <span class="icon-caret-right"></span>'); ?></div>
                </div>
                <?php
