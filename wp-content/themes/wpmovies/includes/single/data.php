...
<span class="abc-r" style="width: <?php $values = get_post_custom_values("imdbRating"); echo $values[0]*10; ?>%;"></span>
</span>
<div class="imdbdatos">
<i><a href="http://www.imdb.com/title/<?php $values = get_post_custom_values("Checkbx2"); echo $values[0]; ?>/">IMDb</a> <span class="icon-chevron-right2"></span></i>
<i><?php $values = get_post_custom_values("imdbRating"); echo $values[0]; ?>/10</i> 
<i><?php $values = get_post_custom_values("imdbVotes"); echo $values[0]; ?> <?php _e('votes', 'mundothemes'); ?></i>
</div>
</div>
</div>
