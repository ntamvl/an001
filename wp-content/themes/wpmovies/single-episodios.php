...
<?php
        ...
        $args = array('tag__in' => $list_tags, 'post_type' => array('episodios'), 'order' => 'DESC', 'posts_per_page' => 1000, 'orderby' => 'meta_value_num', 'meta_key' => 'episodio_serie');
...
<div class="datos">
    <div class="responsive">
        ...
        if (!empty($previd)) { ?>
            <a rel="prev" href="<?php
            echo get_permalink($previd) ?>">Previous: <?php
        ...
        if (!empty($nextid)) { ?>
            <a rel="next" href="<?php
            echo get_permalink($nextid) ?>">Next: <?php
...
<!-- Related  movies -->
<?php
        include_once 'includes/single/relacionados_ep.php'; ?>
<h4 class="more-episode-title">More episodes</h4>
<?php
        include_once '_list_episode.php'; ?>
